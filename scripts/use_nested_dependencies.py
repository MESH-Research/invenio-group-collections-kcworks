...
def main() -> None:
    ...
    peers_missing = []
    if not PEER_REMOTE_USER_DATA.resolve().is_dir():
        print(f"Peer directory not found at {PEER_REMOTE_USER_DATA}, will use GitHub source")
        peers_missing.append("invenio-remote-user-data-kcworks")
